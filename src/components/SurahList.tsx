...
const SurahList: React.FC<SurahListProps> = ({ searchQuery }) => {
  ...
  return (
    <>
      ...
      <Button
        onClick={scrollToTop}
        className={`fixed bottom-5 right-0 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full shadow-lg transition-transform duration-300 ${
          showScrollButton ? "translate-x-0" : "translate-x-full"
        }`}
